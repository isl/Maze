...
public class Metrics {
    ...
    private ArrayList<SingleTSMetrics> singleTSMetricsList;

    public OverviewMetrics getOverviewMetrics() {
        return overviewMetrics;
    }

    public void setOverviewMetrics(OverviewMetrics overviewMetrics) {
        this.overviewMetrics = overviewMetrics;
    }

    public ArrayList<SingleTSMetrics> getSingleTSMetricsList() {
        return singleTSMetricsList;
    }

    public void setSingleTSMetricsList(ArrayList<SingleTSMetrics> singleTSMetricsList) {
        this.singleTSMetricsList = singleTSMetricsList;
    }
}
