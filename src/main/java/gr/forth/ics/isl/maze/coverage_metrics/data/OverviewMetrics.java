...
@XmlRootElement(name = "OverviewMetrics")
public class OverviewMetrics {
    
    private SSMetrics sSMetrics;
    private TSMetrics tSMetrics;

    public SSMetrics getsSMetrics() {
        return sSMetrics;
    }

    public void setsSMetrics(SSMetrics sSMetrics) {
        this.sSMetrics = sSMetrics;
    }
