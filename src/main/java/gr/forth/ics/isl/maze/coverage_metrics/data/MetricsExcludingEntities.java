...
@XmlRootElement(name = "MetricsExcludingEntities")
public class MetricsExcludingEntities {
    ...
    public ArrayList<ExcludingEntity> getExcludingEntities() {
        return excludingEntities;
    }

    public void setExcludingEntities(ArrayList<ExcludingEntity> excludingEntities) {
        this.excludingEntities = excludingEntities;
    }
    
    public void addExcludingEntity(ExcludingEntity entity){
        if(this.excludingEntities == null){
